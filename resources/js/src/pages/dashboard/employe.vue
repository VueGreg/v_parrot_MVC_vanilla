        ...
        <template #content>
            <main class="row">
                <section class="mobile">
                    ...
                    <div class="message col-9" v-for="user in data.utilisateurs" :key="user.id">
                ...
                <div class="table row">
                    ...
                    <TransitionGroup name="slide-fade">
                        <div class="table__body col-md-10 col-xl-8" v-for="user in data.utilisateurs" :key="user.id">
