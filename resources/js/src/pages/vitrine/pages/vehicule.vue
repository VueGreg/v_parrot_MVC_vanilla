<script setup>
    ...
    const getVehicule = async(slug) => {
        try {
            const response = await axios.get('http://parrotpoo.test/vehicule',  { params: { slug: slug } })
...
<template>
    ...
    <main class="row">
        <div class="title col-8">
            <h2>{{ vehicule.vehicules_marque }} {{ vehicule.vehicules_modele }}</h2>
        ...
        <RouterLink class="router" :to="`/contact/${vehicule.numero_annonce}`">
            ...
            <div class="photos col-9 col-sm-7 col-lg-5">
                <div class="images" v-for="image in vehicule.images" :key="image.id">
                    <img :src="image.adresse" :alt="image.alt">
                </div>
            </div>
        ...
        <div class="informations col-8 col-lg-5">
            ...
            <div class="informations__caracteristiques" v-if="!showStats">
                ...
                <div class="informations__equipement">
                    <p v-if="showStats" v-for="equipement in vehicule.equipements" :key="equipement.id">{{ equipement.description }}</p>
                </div>
        </div>
    </main>
